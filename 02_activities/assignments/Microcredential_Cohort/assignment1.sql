...
FROM customer
FULL OUTER JOIN customer_purchases
...
--Run DROP TABLE first, independent of next query
DROP TABLE IF EXISTS temp.new_vendor;

--Run Create Table independent of next query
CREATE TABLE temp.new_vendor AS
SELECT *
FROM vendor;

--Run Insert Into AFTER Create Table
...
STRFTIME ('%m', market_date) AS purchase_month,
STRFTIME ('%Y', market_date) AS purchase_year,
SUM(quantity*cost_to_customer_per_qty) AS monthly_money_spent
FROM customer_purchases
GROUP BY customer_id, purchase_month, purchase_year
HAVING purchase_month = '04' AND purchase_year = '2022'
